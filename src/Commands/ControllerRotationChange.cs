...
{
    internal class ControllerRotationChange : ControllerCommandBase
    {
        private Axis _axis;
        private float _rotationsPerSecond;
        private string _atomUid;
        private string _controllerName;
        public ControllerRotationChange(Axis axis, float rotationsPerSecond) : this(axis, rotationsPerSecond, (FreeControllerV3)null) { }
        public ControllerRotationChange(Axis axis, float rotationsPerSecond, FreeControllerV3 controller) : base(null)
        {
            _axis = axis;
