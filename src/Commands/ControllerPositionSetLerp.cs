...
{
    internal class ControllerPositionSetLerp : ControllerCommandBase
    {
        private Axis _axis;
        private float _min;
        private float _max;
        ...
        public ControllerPositionSetLerp(Axis axis, float absolutePositionMin, float absolutePositionMax) : this(axis, absolutePositionMin, absolutePositionMax, (FreeControllerV3)null) { }
        public ControllerPositionSetLerp(Axis axis, float absolutePositionMin, float absolutePositionMax, FreeControllerV3 controller) : base(null)
        {
            _axis = axis;
