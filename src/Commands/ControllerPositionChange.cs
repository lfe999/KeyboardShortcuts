...
{
    internal class ControllerPositionChange : ControllerCommandBase
    {
        private Axis _axis;
        private float _unitsPerSecond;
        private string _atomUid;
        private string _controllerName;
        public ControllerPositionChange(Axis axis, float unitPerSecond) : this(axis, unitPerSecond, (FreeControllerV3)null) { }
        public ControllerPositionChange(Axis axis, float unitPerSecond, FreeControllerV3 controller) : base(null)
        {
            _axis = axis;
